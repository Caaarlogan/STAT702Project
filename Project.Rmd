...
round(T,0)
```
Time between the orders T aka Intervory cycle = 12
...
To summarize the analysis above, there were 169591 units of this product was sold and is assumed to be A, the number of items demanded per annum. Based on the 2012 sales, the company should order 5422 units of the product every 12 days. The annual inventory cost is $8132.68
...
```{r}
plot(0, xlim = c(0, 2*t), ylim = c(0, S), type = "n",
     xlab = "Time (days)", ylab = "Stock level",
     main = "Inventory cycles for product 216233");

segments(x0 = c(0,t), y0 = S, x1 = c(t,2*t), y1 = 0) # diagonals
segments(x0 = c(0,t), y0 = 0, x1 = c(0,t), y1 = S)   # vertical
segments(x0 = t1*100, y0 = 0, x1 = t1*100, y1 = S)
```
